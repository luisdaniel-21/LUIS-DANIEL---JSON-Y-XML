<?php
    include("cn.php");
    $id = $_GET["id2"];
    $calzados = "SELECT * FROM calzado WHERE id_calzado = '$id'"; 
...
<head>
    ...
    <title>ACTUALIZAR CALZADOS</title>
    <link rel="stylesheet" href="css/tabla.css">
</head>
<body>

    <form class="container-table container-table-edit" action="procesar_actualizarCal.php" method="post">
        <div class="table__title table__title-edit">CALZADOS REGISTRADO</div>
        ...
        <?php
            $resultado = mysqli_query($conexion, $calzados);
            while($row=mysqli_fetch_assoc($resultado)) { ?>

        <input type="hidden" class="table__item" value="<?php echo $row["id_calzado"];?>" name="id2">
